...
TFile* fS   = new TFile("/star/u/sprastar/v1_u8_res/V0/Lambda.19GeV.root");
TFile* fB   = new TFile("/star/u/sprastar/v1_u8_res/V0/LambdaBG.19GeV.root");
TFile* fOut  = new TFile("pV1L.19GeV.root","recreate");


char  v1v1[50] = "pV1L_19GeV";

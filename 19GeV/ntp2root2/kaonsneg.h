...
#ifdef kaonsneg_cxx
kaonsneg::kaonsneg(Char_t path_file[100]) : fChain(0) {
...
Int_t kaonsneg::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t kaonsneg::LoadTree(Long64_t entry)
{

...
#ifdef kaonspos_cxx
kaonspos::kaonspos(Char_t path_file[100]) : fChain(0) {
...
Int_t kaonspos::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t kaonspos::LoadTree(Long64_t entry)
{

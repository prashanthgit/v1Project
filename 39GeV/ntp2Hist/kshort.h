...
kshort::kshort(TTree *tree) : fChain(0) {
  ...
  Char_t dirname[]="/star/u/sprastar/data01/39GeV/flag/root/";
  void *dirhandle = gSystem->OpenDirectory(gSystem->ExpandPathName(dirname));

  while (file = gSystem->GetDirEntry(dirhandle)) {
    if ( (strstr(file,"pV1K_1F0B3C82FAB4A7CE6C5EA5DBAED6CB2C") != 0) ||  (strstr(file,"pV1K_694C54C541F6F5E7832C9C50CBB6627C") != 0) ){

...
Bool_t StStrangePIDv1Tracks::Proton( StMuTrack *t ){
  ...
  protonTPC = TMath::Abs(t->nSigmaProton() * 1.9 ) <= Constant::mTrackNSigmaProtonMax;
...
Bool_t StStrangePIDv1Tracks::Pion( StMuTrack *t){
  ...
  pionTPC  = TMath::Abs(t->nSigmaPion() * 1.9 ) <= Constant::mTrackNSigmaPionMax;
...
Bool_t StStrangePIDv1Tracks::Kaon( StMuTrack *t){
  ...
  kaonTPC  = TMath::Abs(t->nSigmaKaon() * 1.9 ) <= Constant::mTrackNSigmaKaonMax;

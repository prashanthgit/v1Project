...
TFile* fS   = new TFile("/star/u/sprastar/v1_u8_res/V0/ALambda.15GeV.root");
TFile* fB   = new TFile("/star/u/sprastar/v1_u8_res/V0/ALambdaBG.15GeV.root");
TFile* fOut  = new TFile("pV1A.15GeV.root","recreate");


char  v1v1[50] = "pV1A_15GeV";
